#PBS -S /bin/bash
#PBS -q titan
#PBS -N cntor-armchair-petsc-job
#PBS -j oe
...
#cd $PBS_O_WORKDIR
#cd $MEMBERWORK/mat101/ORNL-VFP-Project/cntor-petsc3.5/armchair
cd $PWD
#
...
#aprun -n ${NNODES} -N 1 -d ${NMPITASKS} ./cntor-petsc -pc_type lu arg1 2>&1 | tee /ccs/home/n8d/cntor-armchair-petsc-N64-pn1-$PBS_JOBID.log
