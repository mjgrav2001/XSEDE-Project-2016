...
c 24000 atoms, 24 atoms per small rings (width), 1000 atoms per large ring, (12,0) zigzag
c       bigr   = 169.50d0
c       smallr = 4.696d0

c 18000 atoms, 24 atoms per small rings (width), 750 atoms per large ring, (12,0) zigzag
c       bigr   = 127.13d0
c       smallr = 4.696d0

c 7200 atoms, 24 atoms per small rings (width), 300 atoms per large ring, (12,0) zigzag
c       bigr   = 50.850d0
c       smallr = 4.696d0


c 16000 atoms, 16 atoms per small rings (width), 1000 atoms per large ring, (8,0) zigzag
c          bigr   = 169.50d0
c          smallr = 3.131d0

c 8000 atoms, 16 atoms per small rings (width), 500 atoms per large ring, (8,0) zigzag
c           bigr   = 84.75d0
c           smallr = 3.131d0

c 4800 atoms, 16 atoms per small rings (width), 300 atoms per large ring, (8,0) zigzag
c        bigr   = 50.850d0
c        smallr = 3.131d0


c 18000 atoms, 18 atoms per small rings (width), 1000 atoms per large ring, (9,0) zigzag
c          bigr   = 169.50d0
c          smallr = 3.522d0

c 9000 atoms, 18 atoms per small rings (width), 500 atoms per large ring, (9,0) zigzag
c          bigr   = 84.75d0
c          smallr = 3.522d0

c 5400 atoms, 18 atoms per small rings (width), 300 atoms per large ring, (9,0) zigzag
c          bigr   = 50.850d0
c          smallr = 3.522d0


c 18000 atoms, 12 atoms per small rings (width), 1500 atoms per large ring, (6,0) zigzag
          bigr   = 254.25d0
          smallr = 2.348d0
