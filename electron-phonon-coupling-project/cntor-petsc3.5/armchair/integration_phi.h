...
{
#pragma omp target map(in:p,IVvalues[p.numEnergySteps],vsd)
	{
...
#pragma omp parallel for firstprivate(p.energyMin,p.energyStep,therm,energy,fermi1,fermi2,emu1,emu2)
...
#pragma omp parallel for firstprivate(c1,c2,c3,c4,c5) reduction(+:corrsd)
