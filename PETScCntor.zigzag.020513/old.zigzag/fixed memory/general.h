...
void AttachLeads(Parameters p, block stm[][3], int isl180[], int isr180[], int isl[], int isr[], 
				 complex<double> gl[4][4], complex<double> gr[4][4])
{
	...
	complex<double> tempcd1, tempcd2, tempcd3, tempcd4;
...
void DetachLeads(Parameters p, block stm[][3], int isl180[], int isr180[], int isl[], int isr[], 
				 complex<double> gl[4][4], complex<double> gr[4][4])
{
	int temp1, temp2, temp3, temp4,
	a1bloc, a2bloc, a3bloc, a4bloc,
