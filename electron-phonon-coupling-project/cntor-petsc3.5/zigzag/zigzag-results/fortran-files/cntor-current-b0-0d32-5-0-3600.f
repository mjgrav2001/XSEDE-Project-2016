...
*******************************************************************************
	...
	subroutine tpos(bigr,smallr,r)
	implicit real*8 (a-h,o-z)
	parameter (imax=3600)
	parameter (idim=12)
	dimension r(imax,3)
	dimension temp1(12),temp2(12)
