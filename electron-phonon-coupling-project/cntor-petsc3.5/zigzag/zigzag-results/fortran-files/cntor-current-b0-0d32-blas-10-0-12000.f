...
c call wiregf to get the metallic wire greens functions.
	   ...
	   do 301 i=1,ig
	      do 301 j=1,ig
c print 441,i,j,gl(i,j),gr(i,j)
		 gtl(i,j)=-dimag(gl(i,j))
		 gtr(i,j)=-dimag(gr(i,j))
c 441		 format(i5,2x,i5,3x,4(d11.5,3x))
 301	      continue
...
c needed for metal to tube couplings.
 ...
 175		       continue
c		write(unit=1337, fmt='(8F8.5)') hmod;
...
C		INVERT HMOD HERE
 ...
 500		continue
		...
		print 205,energy,dos,4.0d0*thop*thop*thop*thop*tofe,fermif	
...
c calculate current as a function of source-drain voltage
	...
	do 40 ivsd=1,nvsd
	   ...
	   emu2 = vsd/2d0
 	   ...
 	   call bodesrule(energymin,engmax)
