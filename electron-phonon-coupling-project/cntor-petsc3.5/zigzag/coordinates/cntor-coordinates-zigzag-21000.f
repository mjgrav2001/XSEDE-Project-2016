...
c zigzag torus, outer radius = bigr+smallr = 205
cc	bigr   = 1200/2*(1.42*3/2)/2/pi = 203.40d0
cc	smallr = 20*1.42*sqrt(3)/2/2/pi = 7.811d0
c    bigr   = 203.40d0
c    smallr = 3.914d0

c 21000 atoms, 20 atoms per small rings (width), 1200 atoms per large ring,
c zigzag torus, outer radius = bigr+smallr = 205
...
c 18000 atoms, 20 atoms per small rings (width), 1200 atoms per large ring,
c zigzag torus, outer radius = bigr+smallr = 205
...
c 15000 atoms, 20 atoms per small rings (width), 1200 atoms per large ring,
c zigzag torus, outer radius = bigr+smallr = 205
...
c 12000 atoms, 20 atoms per small rings (width), 1200 atoms per large ring,
c zigzag torus, outer radius = bigr+smallr = 205
...
c 9000 atoms, 20 atoms per small rings (width), 1200 atoms per large ring,
c zigzag torus, outer radius = bigr+smallr = 205
...
c 6000 atoms, 20 atoms per small rings (width), 1200 atoms per large ring,
c zigzag torus, outer radius = bigr+smallr = 205
