...
void AttachLeads(Parameters p, block** stm, int isl180[], int isr180[], int isl[], int isr[], complex<double> gl[4][4], complex<double> gr[4][4])
{
...
void DetachLeads(Parameters p, block** stm, int isl180[], int isr180[], int isl[], int isr[], complex<double> gl[4][4], complex<double> gr[4][4])
{
	int temp1, temp2, temp3, temp4,
		a1bloc, a2bloc, a3bloc, a4bloc,
		a1pl, a2pl, a3pl, a4pl;
