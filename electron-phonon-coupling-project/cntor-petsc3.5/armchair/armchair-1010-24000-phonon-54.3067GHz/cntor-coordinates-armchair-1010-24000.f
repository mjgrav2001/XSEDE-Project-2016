...
c 12000 atoms, 500 rings, 24 atoms per ring, (6,6) armchair torus:
c            bigr = 97.86d0
c            smallr = 2.0294d0

c 12000 atoms, 600 rings, 20 atoms per ring, (5,5) armchair torus:
c   bigr = 117.43d0
c	smallr = 3.3824d0

c 12000 atoms, 1000 rings, 12 atoms per ring, (3,3) armchair torus:
c	bigr = 195.72
c	smallr = 2.0294d0


c 6000 atoms, 300 rings, 20 atoms per ring, (5,5) armchair torus:
c	bigr = 58.71d0
c	smallr = 3.3824d0

c 6000 atoms, 500 rings, 12 atoms per ring, (3,3) armchair torus:
c	bigr = 97.86
c	smallr = 2.0294d0
