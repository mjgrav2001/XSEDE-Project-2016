...
c 24000 atoms, 20 atoms per small ring (width), 1200 atoms per large ring, (10,0)
c zigzag torus, outer radius = bigr+smallr = 105.606
cc	bigr   = 1200/2*(1.42*3/2)/2/pi = 101.700
cc	smallr = 20/2*1.42*sqrt(3)/2/pi = 3.90566
c	bigr   = 203.400d0
c	smallr = 3.90566d0

c 12000 atoms, 20 atoms per small rings (width), 600 atoms per large ring, (10,0)
c zigzag torus, outer radius = bigr+smallr = 205
cc	bigr   = 600/2*(1.42*3/2)/2/pi = 101.700
cc	smallr = 20/2*1.42*sqrt(3)/2/pi = 1.95283
	bigr   = 101.700d0
	smallr = 3.90566d0
