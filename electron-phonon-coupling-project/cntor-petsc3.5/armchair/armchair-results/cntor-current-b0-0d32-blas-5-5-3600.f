...
c 180 degrees:
c      	data isl180/21,22,1,2/
c      	data isr180/1821,1822,1801,1802/
		
c 180 degrees:
c      	data isl/21,22,1,2/
c      	data isr/1821,1822,1801,1802/

c 180 degrees:
c      	data isl180/41,42,21,22/
c      	data isr180/1841,1842,1821,1822/
		
c 180 degrees:
c      	data isl/41,42,21,22/
c      	data isr/1841,1842,1821,1822/

c 180 degrees:
c      	data isl180/61,62,41,42/
c      	data isr180/1861,1862,1841,1842/
		
c 180 degrees:
c      	data isl/61,62,41,42/
c      	data isr/1861,1862,1841,1842/

c 180 degrees:
c      	data isl180/81,82,61,62/
c      	data isr180/1881,1882,1861,1862/
		
c 180 degrees:
c      	data isl/81,82,61,62/
c      	data isr/1881,1882,1861,1862/

c 180 degrees:
c      	data isl180/101,102,121,122/
c      	data isr180/1901,1902,1881,1882/
		
c 180 degrees:
c      	data isl/101,102,121,122/
c      	data isr/1901,1902,1881,1882/

c 180 degrees:
c      	data isl180/121,122,101,102/
c      	data isr180/1921,1922,1901,1902/
		
c 180 degrees:
c      	data isl/121,122,101,102/
c      	data isr/1921,1922,1901,1902/
...
c 30000 atoms, 750 atoms per major ring, 40 atoms per minor ring, (10,10) armchair torus:
ccc outer radius R = bigr+smallr = 124
c        bigr = 146.79d0
c        smallr = 6.76481d0

c 24000 atoms, 600 atoms per major ring, 40 atoms per minor ring, (10,10) armchair torus:
ccc outer radius R = bigr+smallr = 124
ccc	bigr   = 600*1.42*sqrt(3)/2/2/pi = 117.43
ccc	smallr = 40/2*(1.42*3/2)/2/pi = 6.76481
c        bigr = 117.43d0
c        smallr = 6.76481d0

c 21000 atoms, 525 rings, 40 atoms per ring, (10,10) armchair torus:
c	bigr = 102.75d0
c	smallr = 6.76481d0

c 18000 atoms, 450 rings, 40 atoms per ring, (10,10) armchair torus:
c	bigr = 88.07d0
c	smallr = 6.76481d0

c 15000 atoms, 375 rings, 40 atoms per ring, (10,10) armchair torus:
c	bigr = 73.395d0
c	smallr = 6.76481d0
...
c 9000 atoms, 225 rings, 40 atoms per ring, (10,10) armchair torus:
c	bigr = 44.04d0
c	smallr = 6.76481d0
...
c 3600 atoms, 90 rings, 40 atoms per ring, (10,10) armchair torus:
c	bigr = 17.615d0
c	smallr = 6.76481d0

c 3600 atoms, 180 rings, 20 atoms per ring, (5,5) armchair torus:
	bigr = 35.23d0
	smallr = 3.3824d0
...
c		
 ...
 205		format(3x,d12.5,3x,d12.5,3x,2(d12.5,3x),3x,d12.5)

		write(1339,210) energy,dos,trans,fermif
 210		format(3x,d12.5,3x,d12.5,3x,2(d12.5,3x),3x,d12.5)
