...
// Since the T, T-dagger, U, and U-dagger blocks are set once in the beginning,
// and then are never needed to be updated,
// this only sets up those blocks and ignores the diagonal blocks.
